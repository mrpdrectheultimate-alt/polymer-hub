...
ALL_25_VIDEOS = [
  # ─── BATCH 0 & BATCH 1 (VIDEOS 1 TO 20) ──────────────────────────────────────
  {
  ...
  # ─── SPRINT 0A-R3 BATCH 2 ADDITIONS (VIDEOS 21 TO 25) ───────────────────────
  {
  ...
  },
  {
    ...
    "display_title": "Plastic Packaging Recycling & Life Cycle Case Study",
    ...
    "source_organization": "Industry",
    "source_type": "industry_demonstration",
    "description": "Applied environmental impact and circular economy case study analyzing collection, material recovery, end-of-life recycling loops, and carbon offset for single-use plastic packaging.",
    "academic_review_status": "approved",
    "relevance_score": 86,
    "mapping_confidence": "high",
    "mapping_level": "module",
    "academic_review_notes": "Strong match. Industrial case study analyzing circular recycling systems and packaging life cycle impact."
  }
]

print("=== SPRINT 0A-R3 BATCH 2: 25-VIDEO MASTER AUDIT & RE-MAPPING ===")

headers = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64)"}
audited_records = []
now_iso = datetime.now(timezone.utc).isoformat()

for v in ALL_25_VIDEOS:
    ...
    audited_records.append({
        ...
        "verified_by": "academic_curator_0A_R3_Batch2",
        "academic_review_status": v["academic_review_status"],
        "relevance_score": v["relevance_score"],
        "academic_reviewed_at": now_iso,
        "academic_reviewed_by": "academic_curator_0A_R3_Batch2",
...
audit_report = {
    "sprint": "Sprint 0A-R3 Batch 2 (25 Videos Total)",
    "targetTotalVideos": 25,
