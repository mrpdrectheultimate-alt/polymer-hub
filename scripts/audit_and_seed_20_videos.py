...
ALL_20_VIDEOS = [
  ...
  # ─── SPRINT 0A-R3 BATCH 1 ADDITIONS (5 NEW VIDEOS) ──────────────────────────
  {
    ...
    "source_organization": "Industry",
    "description": "Universal Testing Machine (UTM) operation following ASTM D638 for plastic dogbone specimens: yield point, ultimate tensile strength, elongation at break, and necking.",
    "academic_review_status": "approved",
    "relevance_score": 90,
    "mapping_confidence": "high",
    "mapping_level": "lesson",
    "academic_review_notes": "Strong match. Practical UTM tensile testing demonstration on polymer specimens directly aligned with ASTM D638."
  },
  {
  ...
  },
  {
    ...
    "mapping_confidence": "high",
    "mapping_level": "lesson",
    "academic_review_notes": "Strong match. Academic chemistry lecture detailing sulfur vulcanization mechanisms and polymer network formation."
  },
  {
...
print("=== SPRINT 0A-R3 BATCH 1: 20-VIDEO MASTER AUDIT & RE-MAPPING ===")

headers = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64)"}
audited_records = []
now_iso = datetime.now(timezone.utc).isoformat()

for v in ALL_20_VIDEOS:
    ...
    print(f"[{status}] {v['subject']} ({v['learning_role'].upper()}) | ID: {v['youtubeId']}")
    ...
    audited_records.append({
        ...
        "verified_by": "academic_curator_0A_R3_Batch1",
        "academic_review_status": v["academic_review_status"],
        "relevance_score": v["relevance_score"],
        "academic_reviewed_at": now_iso,
        "academic_reviewed_by": "academic_curator_0A_R3_Batch1",
...
audit_report = {
    "sprint": "Sprint 0A-R3 Batch 1 (20 Videos Total)",
    "targetTotalVideos": 20,
    ...
    "academicBreakdown": {
        ...
        "appliedRoles": len([r for r in audited_records if r["learning_role"] == "applied"]),
