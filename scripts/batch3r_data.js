...
*Engineering Verdict:* Corrected shear rate ($129,474\text{ s}^{-1}$) highlights intense shear heating in the pin gate land, requiring melt temperature monitoring to prevent polycarbonate discoloration.
...
The mass flow of incoming plastic waste feed ($\dot{m}_{feed}$) equals the sum of all 5 output streams:
...
> - **Operating Temperature**: $500^\\circ\\text{C}$ under $\\text{N}_2$ inert atmosphere
...
#### Worked Numerical Example:
**Problem:** A commercial pyrolysis plant processes $\\dot{m}_{feed} = 1000\\text{ kg/h}$ of polyolefin waste. The measured output stream mass rates are:
...
> [!IMPORTANT]
> **Regulatory Status Disclaimer**: Information current as of July 2026. Regulatory targets and CPCB portal rules are subject to official MoEFCC gazette notifications. Financial penalty calculations presented below represent **illustrative financial-risk models** under assumed deficit thresholds.
...
## 2. Learning Objectives
By completing this lesson, you will be able to:
- **Structure** CAPEX and OPEX for a ₹1.25 Crore recycling extrusion plant across 3 sensitivity scenarios.
...
$$\\text{Payback Period (Years)} = \\frac{\\text{Initial Total CAPEX}}{\\text{Annual Post-Tax Net Cash Flow}}$$

> **Base Plant Model Assumptions (Total Initial CAPEX = ₹1.25 Crore = ₹12,500,000):**
> - **Installed Capacity**: $500\\text{ kg/h}$ pelletizing extruder line
> - **Operating Regime**: $20\\text{ hours/day}$, $300\\text{ operating days/year}$ ($6,000\\text{ operating hours/year}$)
> - **Raw Flake Procurement Cost**: ₹55.00/kg
> - **Finished Pellet Selling Price**: ₹69.00/kg
> - **Itemized OPEX Line Items**: Power (150 HP @ ₹8.0/kWh), Labor (8 operators @ ₹22k/mo), Rent (₹75k/mo), ETP/Water, Maintenance ($3\\%$ CAPEX/yr), Working Capital Interest ($10\\%$), Downtime Allowance ($10\\%$), Corporate Tax ($25\\%$).

| Financial Scenario | Capacity Utilization | Annual Production Volume | Net Profit Margin (₹/kg) | Annual Post-Tax Cash Flow | Calculated Payback Period | Financial Interpretation |
|---|:---:|:---:|:---:|:---:|:---:|---|
| **Conservative (Downside)** | $60\\%$ | $1,800,000\\text{ kg/yr}$ | ₹5.00/kg | ₹66.67 Lakhs/yr | **1.87 Years (22.5 Months)** | Low utilization, scrap price pressure |
| **Base (Planning Case)** | $80\\%$ | $2,400,000\\text{ kg/yr}$ | ₹6.25/kg | ₹1.20 Crore/yr | **1.04 Years (12.5 Months)** | Standard production efficiency |
| **Optimistic (Upside)** | $90\\%$ | $2,700,000\\text{ kg/yr}$ | ₹8.00/kg | ₹1.63 Crore/yr | **0.77 Years (9.2 Months)** | Peak demand, high margin compounding |

#### Worked Base Scenario Calculation:
1. Annual Sales Income $= 2,400,000\\text{ kg} \\times \\text{₹}69/\\text{kg} = \\text{₹}16.56\\text{ Crore}$.
2. Total Direct Costs & OPEX $= \\text{₹}14.96\\text{ Crore/yr}$.
3. Pre-tax Profit $= \\text{₹}1.60\\text{ Crore}$.
4. Post-tax Cash Flow (25% tax) $= \\text{₹}1.20\\text{ Crore/yr}$.
$$\\text{Base Payback Period} = \\frac{\\text{₹}1.25\\text{ Crore}}{\\text{₹}1.20\\text{ Crore/yr}} = 1.04\\text{ Years} \\quad (12.5\\text{ Months})$$
