...
async function seed30Videos() {
  console.log("=== SPRINT 0A-R3 COMPLETE: SEEDING 30 AUDITED & ACADEMICALLY CURATED VIDEOS TO SUPABASE ===");
  ...
  for (const v of videos) {
    ...
    if (error) {
      ...
      console.log(`Successfully seeded video #${v.id.slice(-2)} -> ${v.subject} [${v.learning_role.toUpperCase()}]`);
    }
  }

  console.log("\nDatabase seeding completed 100% cleanly for ALL 30 VIDEOS!");
}
